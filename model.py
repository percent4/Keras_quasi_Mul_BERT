# -*- coding: utf-8 -*-
# @Time : 2021/3/25 18:21
# @Author : Jclian91
# @File : model.py
# @Place : Yangpu, Shanghai
# main architecture of quasi Mul-BERT
from keras.models import Model
from keras.utils import plot_model
from keras.layers import Input, Lambda, Dense, Dropout, concatenate, Dot, Add
from keras_bert import load_trained_model_from_checkpoint


# model structure of quasi Mul-BERT
class QuasiMulBERT(object):
    ...
    def create_model(self):
        ...
        e1_cls_layer = Add()([cls_layer, e1_layer])     # add cls layer and e1_layer
        e2_cls_layer = Add()([cls_layer, e2_layer])     # add cls layer and e2_layer
        e1_cls_fc_layer = self.crate_fc_layer(e1_cls_layer, output_dim, dropout_rate=0.1)
        e2_cls_fc_layer = self.crate_fc_layer(e2_cls_layer, output_dim, dropout_rate=0.1)
        concat_layer = concatenate([e1_cls_fc_layer, e2_cls_fc_layer], axis=-1)
